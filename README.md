...
- `hermes_docs_refresh` ограничен одним обновлением в `HERMES_DOCS_MCP_MIN_REFRESH`
  секунд (по умолчанию 300), чтобы инстанс нельзя было превратить в кнопку
  «скачай пять мегабайт» для всех желающих;
